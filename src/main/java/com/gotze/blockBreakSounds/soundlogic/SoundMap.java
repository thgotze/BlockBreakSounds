...
public class SoundMap {
    ...
    public static final Map<ItemStack, Map<ItemStack, List<SoundData>>> ITEM_SOUNDS = new HashMap<>(); // Diamond axe
    ...
    static {
        ...
        ITEM_SOUNDS.put(createItemStack(Material.DIAMOND_AXE, "Item Sounds"), new HashMap<>() {{
            // Trident Sounds
            put(createItemStack(Material.TRIDENT, "Trident Sounds"), List.of(
            ...
            // Goat Horn Sounds
            put(createItemStack(Material.GOAT_HORN, "Goat Horn Sounds"), List.of(
                    new SoundData(Sound.ITEM_GOAT_HORN_SOUND_0, Material.TRIDENT),
                    new SoundData(Sound.ITEM_GOAT_HORN_SOUND_1, Material.TRIDENT),
                    new SoundData(Sound.ITEM_GOAT_HORN_SOUND_2, Material.TRIDENT),
                    new SoundData(Sound.ITEM_GOAT_HORN_SOUND_3, Material.TRIDENT),
                    new SoundData(Sound.ITEM_GOAT_HORN_SOUND_4, Material.TRIDENT),
                    new SoundData(Sound.ITEM_GOAT_HORN_SOUND_5, Material.TRIDENT),
                    new SoundData(Sound.ITEM_GOAT_HORN_SOUND_6, Material.TRIDENT),
                    new SoundData(Sound.ITEM_GOAT_HORN_SOUND_7, Material.TRIDENT)
            ));
            // Player Armor Sounds
            put(createItemStack(Material.IRON_CHESTPLATE, "Player Armor Sounds"), List.of(
            ...
            // Axe Sounds
            put(createItemStack(Material.IRON_AXE, "Axe Sounds"), List.of(
            ...
            // Crossbow Sounds
            put(createItemStack(Material.CROSSBOW, "Crossbow Sounds"), List.of(
            ...
            // Bucket Sounds
            put(createItemStack(Material.BUCKET, "Bucket Sounds"), List.of(
            ...
            // Brush Sounds
            put(createItemStack(Material.BRUSH, "Brush Sounds"), List.of(
            ...
            // Bundle Sounds
            put(createItemStack(Material.BUNDLE, "Bundle Sounds"), List.of(
            ...
            // Bottle Sounds
            put(createItemStack(Material.GLASS_BOTTLE, "Bottle Sounds"), List.of(
            ...
            // Wolf Armor Sounds
            put(createItemStack(Material.WOLF_ARMOR, "Wolf Armor Sounds"), List.of(
            ...
            // Mace Sounds
            put(createItemStack(Material.MACE, "Mace Sounds"), List.of(
            ...
            // Other Sounds
            put(createItemStack(Material.GLASS, "Mace Sounds"), List.of(
                    new SoundData(Sound.ITEM_MACE_SMASH_AIR, Material.MACE),
